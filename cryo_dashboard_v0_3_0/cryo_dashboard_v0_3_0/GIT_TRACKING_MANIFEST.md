...
git tag -a v0.4.8 -m "v0.4.8 release"
git archive --format=zip --output=cryo_dashboard_v0.4.8_clean.zip HEAD
```
...
**Manifest Status:** Current for v0.4.8
